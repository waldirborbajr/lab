    ...
    <div class="bp-section">
      <div class="bg-blue-400">
        <div class="grid grid-cols-4 gap-1">
          ...
          <div class="bp-font-grid bg-blue-600">Bank</div>
          <div class="bp-font-grid bg-blue-600">Agency</div>
          <div class="bp-font-grid bg-blue-600">Acount</div>
          <div class="bp-font-grid bg-blue-600">Delete</div>

          <div class="bp-font-grid bg-slate-300">Universal</div>
          <div class="bp-font-grid bg-slate-300">0000</div>
          <div class="bp-font-grid bg-slate-300">9999</div>
          <div class="bp-font-grid bg-slate-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
